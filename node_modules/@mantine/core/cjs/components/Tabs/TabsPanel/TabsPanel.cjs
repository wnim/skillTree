...
const TabsPanel = require_factory.factory((_props) => {
	const props = require_use_props.useProps("TabsPanel", null, _props);
...
TabsPanel.classes = require_Tabs_module.default;
