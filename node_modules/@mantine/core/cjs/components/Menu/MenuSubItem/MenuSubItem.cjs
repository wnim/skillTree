...
//#region packages/@mantine/core/src/components/Menu/MenuSubItem/MenuSubItem.tsx
const MenuSubItem = require_polymorphic_factory.polymorphicFactory((props) => {
	const { classNames, className, style, styles, vars, color, leftSection, rightSection, children, disabled, "data-disabled": dataDisabled, closeMenuOnClick, ref, ...others } = require_use_props.useProps("MenuSubItem", null, props);
	...
	const parsedThemeColor = color ? require_parse_theme_color.parseThemeColor({
		color,
		theme
	}) : null;
	const handleKeydown = require_create_event_handler.createEventHandler(_others.onKeyDown, (event) => {
	...
	const handleClick = require_create_event_handler.createEventHandler(_others.onClick, () => {
		if (!dataDisabled && closeMenuOnClick) ctx.closeDropdownImmediately();
	});
	const handleMouseEnter = require_create_event_handler.createEventHandler(_others.onMouseEnter, subCtx?.open);
	const handleMouseLeave = require_create_event_handler.createEventHandler(_others.onMouseLeave, subCtx?.close);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(require_UnstyledButton.UnstyledButton, {
		...
		ref: (0, _mantine_hooks.useMergedRef)(itemRef, ref),
		role: "menuitem",
		disabled,
		"data-menu-item": true,
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				"data-position": "right",
				children: rightSection || /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_AccordionChevron.AccordionChevron, {
...
MenuSubItem.classes = require_Menu_module.default;
