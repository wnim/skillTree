...
const Slider = require_factory.factory((_props) => {
	...
	const { ref: container, active } = (0, _mantine_hooks.useMove)(({ x, y }) => handleChange({ x: orientation === "vertical" ? 1 - y : x }), { onScrubEnd: (0, react.useCallback)(() => {
